...
void InitonUserMotionIF(void)
{
    emcmotCommand = new emcmot_command_t;
    emcmotStatus = new emcmot_status_t;
    emcmotConfig = new emcmot_config_t;
    emcmotInternal = new emcmot_internal_t;
    emcmotError = new emcmot_error_t;
