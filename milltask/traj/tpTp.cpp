        ...
        TC_STRUCT * const blend_tc)
{
    ...
    tc_blend_type_t best_blend = (tc_blend_type_t)find_max_element(perf, 3);
...
STATIC tc_blend_type_t tpHandleBlendArc(TP_STRUCT * const tp, TC_STRUCT * const tc) {
    ...
    switch (res_tan) {
        ...
        case TP_ERR_OK:
            return (tc_blend_type_t)res_tan;
